...
public class Picture extends SimplePicture {
  ...
  ////////////////////// methods ///////////////////////////////////////
    ...
    public void blur(int row, int col, int width, int height)
    {
         Pixel[][] pixels = this.getPixels2D();
         Pixel pixelObj = null;
         for(int r = row; r < row + height; r++ )
         {
             ...
             {
                 pixelObj = pixels[r][c];
                 pixelObj.setRed((pixels[r-1][c-1].getRed() + pixels[r-1][c].getRed() +  pixels[r-1][c+1].getRed() + pixels[r][c-1].getRed() + pixels[r][c+1].getRed() +pixels[r+1][c-1].getRed() + pixels[r+1][c].getRed() +pixels[r+1][c+1].getRed())/8);
                pixelObj.setGreen((pixels[r-1][c-1].getBlue() + pixels[r-1][c].getBlue() +  pixels[r-1][c+1].getBlue() + pixels[r][c-1].getBlue() + pixels[r][c+1].getBlue() +pixels[r+1][c-1].getBlue() + pixels[r+1][c].getBlue() +pixels[r+1][c+1].getBlue())/8);
                pixelObj.setBlue((pixels[r-1][c-1].getGreen() + pixels[r-1][c].getGreen() +  pixels[r-1][c+1].getGreen() + pixels[r][c-1].getGreen() + pixels[r][c+1].getGreen() +pixels[r+1][c-1].getGreen() + pixels[r+1][c].getGreen() +pixels[r+1][c+1].getGreen())/8);
             }
         }
